...
public class DrupalMediaIndexerTest extends IndexerTestBase {
    ...
    @Test
    public void testIndexImages() throws IOException {
        try (SearchClient client = this.createElasticsearchClient()) {
            ...
            String configPath = "drupalImageFiles";
            URL configUrl = DrupalMediaIndexerTest.class.getClassLoader().getResource(configPath);
            drupalMediaIndexer.setDrupalUrl(configUrl.toString());
