...
public class AtlasMapperIndexerTest extends IndexerTestBase {
    ...
    public void testIndexLayers() throws Exception {
        try (MockSearchClient searchClient = this.createMockSearchClient()) {
            ...
            mockHttpClient.addGetUrl("https://domain.com/config/main.json", "atlasmapperFiles/config/main.json");
            mockHttpClient.addGetUrl("https://domain.com/config/layers.json", "atlasmapperFiles/config/layers.json");
